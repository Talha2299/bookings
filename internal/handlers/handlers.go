...
import (
	...
	"github.com/Talha2299/bookings/internal/repository"
	"github.com/Talha2299/bookings/internal/repository/dbrepo"
...
// NewTestRepo creates a repository
...
func (m *Repository) Reservations(w http.ResponseWriter, r *http.Request) {
	...
	if err != nil {
		m.App.Session.Put(r.Context(), "error", "can't fins room!")
		http.Redirect(w, r, "/", http.StatusSeeOther)
		return
	}
...
func (m *Repository) PostReservations(w http.ResponseWriter, r *http.Request) {
	...
	// send notification - firdt to guest
...
// ReservationSummary display the res summary page
...
// BookRoom takes URL params, build a sessional variables and takes user to reservation screen
...
// ShowLoginshows the login screen
...
// AdminReservationsCalender shows the reservation in the admin tool
...
// AdminReservationsCalender shows the reservation calender
func (m *Repository) AdminReservationsCalender(w http.ResponseWriter, r *http.Request) {
	...
	for _, x := range rooms {
		...
		// get all the restriction for the current rrom
